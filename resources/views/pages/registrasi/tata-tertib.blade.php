...
<div class="container mx-auto py-16">
    <h1 class="text-center text-lg px-6 md:text-2xl lg:text-3xl">Tata Tertib Pelayanan Program Lapor Mas Wapres!</h1>
        <div class="w-11/12 md:w-4/5 bg-blue-200 p-6 md:p-10 lg:p-16 rounded-md md:rounded-xl mx-auto text-clip text-sm md:text-base">
            <div class="content">
            <h3 class="font-semibold mb-1">A. Ketentuan Umum</h3>
            <div class="list pl-5 mb-4">
            ...
            <div class="list pl-5 mb-4">
                ...
                <li>
                    ...
                    <a href="https://lapormaswapres.id" class="text-blue-800"
