...
<div class="flex flex-col justify-center items-center gap-y-5">
    ...
    <a href="{{ route('tindaklanjut') }}" class="w-full bg-gradient-to-r from-primary to-secondary text-white text-center font-semibold text-sm py-3 rounded-lg transform hover:scale-105 transition duration-300 hover:shadow-custom cursor-pointer">
