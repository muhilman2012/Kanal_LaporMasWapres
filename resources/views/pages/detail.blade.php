        ...
        <div class="text-md text-dark-700 mb-4">
            ...
            <li><strong>KETENTUAN PENGADUAN</strong>
                <ol>
                    ...
                    <li>5. Petugas memverifikasi dokumen. Apabila dokumen tidak lengkap, petugas akan meminta pelapor untuk mengirimkan kelengkapan dokumen melalui e-mail ( persuratan@set.wapresri.go.id ) dalam kurun waktu 10 hari. Pelaporan tidak diproses apabila pelapor tidak melengkapi dokumen tersebut dalam 10 hari.</li>
