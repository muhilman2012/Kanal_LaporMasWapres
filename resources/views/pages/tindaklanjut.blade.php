...
<head>
    ...
    <title>Lapor Mas Wapres! - Form Registrasi Tindak Lanjut</title>
    <meta property="og:title" content="Lapor Mas Wapres! - Form Registrasi Tindak Lanjut">
    ...
    <style>
        ...
        /* Gaya untuk iframe agar mengisi seluruh panel */
        #JotFormIFrame-243191381497463 {
            height: 100%;
            width: 100%;
            border: none;
        }
...
<body>
    <iframe
      id="JotFormIFrame-243578346511460"
      title="LAPOR MAS WAPRES"
      onload="window.parent.scrollTo(0,0)"
      allowtransparency="true"
      allow="geolocation; fullscreen"
      src="https://form.jotform.com/243578346511460"
      frameborder="0"
    ...
    <script>window.jotformEmbedHandler("iframe[id='JotFormIFrame-243578346511460']", "https://form.jotform.com/")</script>
</body>
