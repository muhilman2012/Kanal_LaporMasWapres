...
<head>
    ...
    <title>Lapor Mas Wapres! - Form Registrasi Online</title>
    <meta property="og:title" content="Lapor Mas Wapres! - Form Registrasi Online">
...
<body>
    <iframe
        id="JotFormIFrame-243188226197060"
        title="LAPOR MAS WAPRES"
        onload="window.parent.scrollTo(0,0)"
        allowtransparency="true"
        allow="geolocation; microphone; camera; fullscreen"
        src="https://form.jotform.com/243188226197060"
        frameborder="0"
    ...
    <script>window.jotformEmbedHandler("iframe[id='JotFormIFrame-243188226197060']", "https://form.jotform.com/")</script>
</body>
