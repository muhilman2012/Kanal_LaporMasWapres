...
@section('pages')
<!-- Content -->
<div class="flex flex-1 flex-col justify-center items-center gap-y-5">
    <div class="flex flex-col gap-y-1 items-center justify-center text-center sm:mt-10">
        <h2 class="font-bold text-xl sm:text-2xl text-primary">Sampaikan Laporan Anda melalui pilihan kanal berikut ini</h2>
    ...
    <div class="grid gap-y-4 sm:gap-y-5 w-full sm:grid-cols-1 md:grid-cols-2 gap-x-5 my-5 sm:my-[64px] max-w-[968px]">
        ...
        <a href="mailto:persuratan@set.wapresri.go.id" target="_blank" class="hover:cursor-pointer group flex gap-x-4 px-4 py-3 w-full bg-white transform hover:scale-105 transition duration-300 hover:shadow-custom hover:bg-gradient-to-r from-white to-secondary border-primary hover:border-secondary border rounded-lg items-center">
            ...
            <div class="flex flex-col">
                <p class="font-bold text-sm sm:text-base text-primary">Korespondensi Surat melalui Surel</p>
                <p class="font-normal text-xs sm:text-sm text-primary">Kirimkan pengaduan melalui Surel ke <i>persuratan@set.wapresri.go.id</i></p>
            </div>
        </a>

        <a href="https://lapor.go.id/" target="_blank" class="hover:cursor-pointer group flex gap-x-4 px-4 py-3 w-full bg-white transform hover:scale-105 transition duration-300 hover:shadow-custom hover:bg-gradient-to-r from-white to-secondary border-primary hover:border-secondary border rounded-lg items-center">
            ...
            <div class="flex flex-col">
                ...
                <p class="font-normal text-xs sm:text-sm text-primary">Laporkan <i>online</i> melalui <i>https://lapor.go.id</i></p>
            </div>
        </a>
    </div>
</div>
