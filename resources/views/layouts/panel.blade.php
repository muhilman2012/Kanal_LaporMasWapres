...
<body class="bg-gray-50 text-gray-900">
    ...
    <div id="content" class="flex flex-col h-dvh max-w-sm p-6 gap-y-7 sm:max-w-2xl lg:max-w-5xl xl:max-w-7xl mx-auto bg-[url('/assets/LaporMasWapres-opacity.webp')] bg-no-repeat bg-center bg-contain bg-fixed sm:bg-[length:600px] items-center">
        <!-- Navbar -->
        ...
        <div class="flex flex-col gap-1 w-full max-w-[440px] items-center pb-7">
            ...
            <a href="https://wa.me/6281117042207/?text=Halo" target="_blank" class="w-full bg-gradient-to-r from-primary to-secondary text-white text-center font-semibold text-sm py-3 rounded-lg">Hubungi Layanan Pelanggan</a>
