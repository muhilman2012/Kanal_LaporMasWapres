        ...
        <div class="flex flex-col gap-1 w-full max-w-[460px] items-center pb-7">
            ...
            <div class="flex gap-x-4 my-3">  
                ...
                <a href="https://www.facebook.com/wapresri.go.id" target="_blank">  
                    <svg class="hover:text-primary text-secondary transform transition duration-300" width="32" height="32" viewBox="0 0 40 40" fill="currentColor" xmlns="www.w3.org/2000/svg">  
